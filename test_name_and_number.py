...
class Test(TestCase):
    def test_name_and_phone_number(self):
        self.assertEqual(name_and_phone_number(),  f"Hello, BLYAT, is 114514188180 your phone number?")

    def test_what_type_does_input_return(self):
        self.assertEqual(what_type_does_input_return(), "Your favorite number is 114514")

    def test_add_your_two_favorite_numbers(self):
        self.assertEqual(add_your_two_favorite_numbers(), f"The sum of your favorite numbers is 114515")
